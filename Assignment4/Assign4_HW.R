...
ggsave("infant_mortality_plot.png", plot_m3)
...
modelsummary(list("Level" = m1, "Log-Log" = m2, "Controls" = m3, "Interaction" = m4), vcov = "robust", stars = TRUE, gof_map = c("r.squared", "nobs"))
